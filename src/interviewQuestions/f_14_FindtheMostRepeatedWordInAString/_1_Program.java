 ...
 *
 */
package interviewQuestions.f_14_FindtheMostRepeatedWordInAString;
...
public class _1_Program {
	...
	private static String stringWithHighestFrequency(String[] a) {
		...
		for (String s : a) {
			Integer repeatedInteger = hashMap.get(s);
			hashMap.put(s, (repeatedInteger == null) ? 1 : repeatedInteger + 1);
		}
		/*
