 ...
 * 
 * When line-1 execute, it will create two objects and pointing to the heap area
 * created object.
 * 
 * Now when line-2 executes, it will refer to the object which is in the SCP.
 * 
 * Again when line-3 executes, it refers to the same object which is in the SCP
 * area because, the content is already available in the SCP area. No need to
