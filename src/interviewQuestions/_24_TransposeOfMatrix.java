...
class Matrix {
    ...
    //  Read more: https://www.java67.com/2016/10/how-to-transpose-matrix-in-java-example.html#ixzz6oSfWpN6u
}


public class _24_TransposeOfMatrix {
    public static void main(String[] args) {
        ...
        first.print(); // let's transpose the matrix now
        first.transpose();
        System.out.println("transpose of the matrix is ");
        first.print();
        scnr.close();

        //  Read more: https://www.java67.com/2016/10/how-to-transpose-matrix-in-java-example.html#ixzz6oSfqHLtl
