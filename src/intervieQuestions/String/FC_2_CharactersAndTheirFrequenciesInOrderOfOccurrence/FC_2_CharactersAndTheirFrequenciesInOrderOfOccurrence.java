package intervieQuestions.String.FC_2_CharactersAndTheirFrequenciesInOrderOfOccurrence;

// Java implementation to print the character and 
//its frequency in order of its occurrence 
public class FC_2_CharactersAndTheirFrequenciesInOrderOfOccurrence { 
