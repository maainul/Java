...
public class _24_PrintCommonCharactersOfTwoStringsinAlphabeticalOrder {
	...
	private static void printstring(String string1, String string2) {
		...
		for (int i = 0; i < string1.length(); i++) {
			...
			System.out.println(arr1[string1.charAt(i) - 'a'] + "--" + string1.charAt(i));
		...
		for (int i = 0; i < string2.length(); i++) {
			...
			System.out.println(arr2[string2.charAt(i) - 'a'] + "--" + string2.charAt(i));
		...
		for (int i = 0; i < 26; i++) {
			if (arr1[i] != 0 && arr2[i] != 0) {
				System.out.println(i + "----" + arr1[i] + "--" + ((char) (i + 'a')));
				System.out.println(i + "----" + arr2[i] + "--" + ((char) (i + 'a')));
