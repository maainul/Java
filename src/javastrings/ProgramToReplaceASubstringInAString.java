...
Program to replace a substring in a string is discussed here. 
...
Find the substring from the full string and 

replace the new substring with the old substring (Find s2 from s1 and replace s1 by s3).
