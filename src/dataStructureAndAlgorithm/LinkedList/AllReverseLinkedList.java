...
public class AllReverseLinkedList {
	...
	/*
	 * Reverse a Linked List in groups of given size | Set 1 Given a linked list,
	 * write a function to reverse every k nodes (where k is an input to the
	 * function).
	 * 
	 * Example:
	 * 
	 * Input: 1->2->3->4->5->6->7->8->NULL, K = 3 Output:
	 * 3->2->1->6->5->4->8->7->NULL
	 * 
	 * Input: 1->2->3->4->5->6->7->8->NULL, K = 5 Output:
