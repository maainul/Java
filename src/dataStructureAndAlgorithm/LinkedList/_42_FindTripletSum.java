...
public class _42_FindTripletSum {
	 ...
	 */
	boolean isSumSorted(_42_FindTripletSum la, _42_FindTripletSum lb, _42_FindTripletSum lc, int givenNumber) {
		Node a = la.head;
	...
	public static void main(String args[]) {
		...
		/*
		 * ascending order/ /*create a sorted linked list 'b' 2->4->9->10
		 */
		llist2.push(10);
		llist2.push(9);
		llist2.push(4);
		...
		/*
		 * descending order / /*create another sorted linked list 'c' 8->4->2->1
		 */
		llist3.push(1);
		llist3.push(2);
		llist3.push(4);
