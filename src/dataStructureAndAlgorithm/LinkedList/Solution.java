...
public class Solution {
	...
	/*
	 * if(flag){ System.out.println("Data found in Position = "+position); }else {
	 * System.out.println("Data not Found"); }
	 */
	...
	// 15. Write a function that counts the number of times a given int occurs in a
	// linked list
	...
	public static void main(String[] args) {
		...
		l1.head = new Solution().mergeTwoSortedLinkedList(l1.head, l2.head);
...
//---------------Alter split-------------------------------------
		 ...
		 * alObj.alternateSplit(alObj.head);
		 * 
		 * alObj.print(alObj.firstHead); System.out.println();
		 * 
...
// solution https://thecodingsimplified.com/split-linked-list-alternatively-into-two-lists/
		...
		Solution.print(alObj.headA);

		System.out.println();

		Solution.print(alObj.headB);
