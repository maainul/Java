...
![binary_tree-1](https://user-images.githubusercontent.com/37740006/108923796-a78fef80-7663-11eb-98a2-036fc99fe082.png)
...
Print the level order of nodes in following specific manner:
  ...
  ```java
  package dataStructureAndAlgorithm.Tree.BinaryTree.traversal._18_PerfectBinaryTreeSpecificLevelOrderTraversal;
...
public class BinaryTree {
	...
	private void printSpecificLevelOrder(Node node) {
		...
		// since it is perfect binary reee, right is not checked
		if (node.left != null) {
